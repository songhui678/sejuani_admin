<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/index\index.html";i:1514476074;s:42:"./application/admin/view2/public\left.html";i:1514475687;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $SquareDental_config['shop_info_store_logo']; ?>" media="screen"/>
<title>SquareDental2.0</title>
...
<div class="admincp-header">
  ...
  <div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
    <!-- <h2 style="cursor:pointer;">SquareDental2.0<br>平台系统管理中心</h2> -->
    <!-- <img src="__PUBLIC__/static/images/TPlogo.png" alt=""> -->
    <span><h2>SquareDental</h2></span>
  </div>
...
<!--      <li data-param="mobile"><a href="javascript:void(0);">模板</a></li>-->
  ...
  <div class="admincp-header-r">
    ...
    <ul class="operate nc-row">
      <li style="display: none !important;" tptype="pending_matters"><a class="toast show-option" href="javascript:void(0);" onClick="$.cookie('commonPendingMatters', 0, {expires : -1});ajax_form('pending_matters', '待处理事项', 'http://www.SquareDental.cn/admin/index.php?act=common&op=pending_matters', '480');" title="查看待处理事项">&nbsp;<em>0</em></a></li>
...
<div class="admincp-container-left">
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?> 
    <div class="about" title="关于系统" onclick="javascript:layer.open({type: 2,title: '关于我们',shadeClose: true,shade: 0.3,area: ['50%', '60%'],content:'<?php echo U("Index/about"); ?>', });"><i class="fa fa-copyright"></i><span>SquareDental.cn</span></div>
</div>
