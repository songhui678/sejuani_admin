<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view2/promotion\group_buy_list.html";i:1509957135;s:44:"./application/admin/view2/public\layout.html";i:1509957135;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo date('Y-m-d H:i',$vo['start_time']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo date('Y-m-d H:i',$vo['end_time']); ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<a class="btn blue" target="_blank" href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vo[goods_id],'item_id'=>$vo[item_id])); ?>"><i class="fa fa-search"></i>查看</a>
